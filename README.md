...
A thank you to [Mystic Effects Co](https://mysticeffectsco.com) for a helpful and inspiring FL9 capacitor replacement blog post. Also to Panasonic for continuing to maintain on-line datasheets for the bucket brigade delay and clock driver chip set and to DigiKey for stocking fresh through-hole capacitors in their produce aisle.
