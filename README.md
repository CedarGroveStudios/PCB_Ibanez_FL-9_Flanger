# PCB_Ibanez_FL-9_Flanger
 ...
 NOTE: At this time, the updated PCB design is only useful for relative component location. The PCB design is non-functional and cannot be fabricated as-is.
